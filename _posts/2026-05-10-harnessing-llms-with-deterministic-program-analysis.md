...
- **Other techniques can be brought to bear.** The seven techniques described here are the ones that proved most useful in practice; many of them are built on [SootUp](https://soot-oss.github.io/SootUp/)'s analysis infrastructure. Others are available depending on the failure mode.
